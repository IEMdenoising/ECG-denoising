...
void SimpleDatHandler::readFileToVector(std::string path, std::string fileName, std::vector<float> &outSignal)
{
...
void SimpleDatHandler::writeVectorToFile(std::string path, std::string fileName, std::vector<float> signal)
{
	std::ofstream file;
